...
my $epsilon=($ea*(1-$B)+$eb*$B)->slice("*1,*1");                    # microscopic 1D diel. func.
...
my $flo=Photonic::LE::ST::Field->new(haydock=>$haydock, nh=>10); # field longitudinal object
...
my $epsilont=($ea*(1-$Bt)+$eb*$Bt)->slice("*1,*1")*identity(2);  # microscopic 2D diel. func.
...
my $fto=Photonic::LE::ST::Field->new(haydock=>$nt, nh=>10);     # field transverse object
