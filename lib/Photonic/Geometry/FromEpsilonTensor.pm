package Photonic::Geometry::FromEpsilonTensor;
$Photonic::Geometry::FromEpsilonTensor::VERSION = '0.024_01';
...
has 'epsilon'=>(is=>'ro', isa=>PDLComplexMatrixField, required=>1,
		documentation=>'Dielectric tensor as function of position');
...
sub _build_B {
    my $self=shift;
    return $self->epsilon->slice([0,0,0],[0,0,0]); #value is irrelevant. Only
				#shape of pdl counts.
}
