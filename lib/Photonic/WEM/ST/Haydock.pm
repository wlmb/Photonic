...
$Photonic::WEM::ST::Haydock::VERSION = '0.02402';

=encoding UTF-8

=head1 NAME

Photonic::WEM::ST::Haydock
...
=item * metric Photonic::WEM::ST::Metric

A L<Photonic::WEM::ST::Metric> object defining the geometry of the
...
ri,xy,pm,nx,ny... The Hamiltonian is the metric followed by the
