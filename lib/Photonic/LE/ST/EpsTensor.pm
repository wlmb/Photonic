...
$Photonic::LE::ST::EpsTensor::VERSION = '0.02401';
...
=head1 SYNOPSIS
   ...
   my $eps=Photonic::LE::ST::EpsTensor->new(
...
has allh_class=>(is=>'ro', default=>'Photonic::LE::ST::Haydock');
has allh_attrs=>(is=>'ro', default=>sub{[qw(reorthogonalize use_mask mask)]});
has epsl_class=>(is=>'ro', default=>'Photonic::LE::ST::EpsL');
