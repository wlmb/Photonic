...
$Photonic::LE::ST::EpsL::VERSION = '0.024_01';
...
=head1 SYNOPSIS
   ...
   my $eps=Photonic::LE::ST::EpsL->new(haydock=>$haydock, nh=>$nh);
   my $epsilonLongitudinal=$eps->epsL;

=head1 DESCRIPTION

Calculates the macroscopic longitudinal dielectric function for a given fixed
Photonic::LE::ST::Haydock structure as a function of the dielectric
